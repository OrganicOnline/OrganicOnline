<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Genel.master" CodeFile="Siparislerim.aspx.cs" Inherits="Siparişlerim" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title"><b>Siparişlerim</b></h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
                        ...
                        <li class="item">
                            <div class="col-md-3" style="border-right: groove; padding-left: 0px;">
                                <asp:Panel ID="pnlButtons" runat="server">
                                    <div class="product-info">
                                        ...
                                        <p>
                                            <asp:Button Text="Ürün Elime Ulaşmadı" ID="btnIptal" CommandName='iptal' CommandArgument='<%#Eval("ObjectId") %>' CssClass="btn btn-danger btn-xs" runat="server" />
                                            <asp:Button Text="Ürünü Teslim Aldım" ID="btnOnay" CommandName='onay' CommandArgument='<%#Eval("ObjectId") %>' CssClass="btn btn-primary btn-xs" runat="server" />
                                        </p>
                                    </div>
                                </asp:Panel>
                            ...
                            <div class="col-md-2 " style="border-right: groove; margin-left: -50px;">
                                <div class="product-info">
                                    ...
                                    <span class="product-description"><b><%#Eval("Quantity") %> kg</b> - (<%#Eval("Product.Price") %> kg/TL)
                                    </span>
